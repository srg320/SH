...
`ifdef SIM
	...
	reg [15:0] MEM [128] = '{
		...
		16'b1110_0000_00101100,		//MOV		#$2C,R0
		16'b1100_1101_00001111,		//AND.B	#$0F,@(R0,GPR)
		16'b1110_0001_01010110,		//MOV		#$56,R1
		16'b0100_0000_0001_1011,	//TAS.B	@R0
		16'b0000_0000_0010_1011,	//RTE
		16'b1110_0001_01111000,		//MOV		#$78,R1
		16'b0000_0000_0000_1001,	//NOP
		//20
		16'b0000_0000_0000_1001,	//NOP
		16'b1010_000000000101,		//BRA		#5
		16'b1110_0000_10101010,		//MOV		#$AA,R0
		16'b0000_0000_0000_1001,	//NOP
		16'b1110_0001_00011000,		//MOV		#$18,R1
		16'b1110_0010_00110100,		//MOV		#$34,R2
		16'b1110_0001_01010110,		//MOV		#$56,R1
		16'b0000_0000_0001_1000,	//SETT
		//30
		16'b1000_1001_00000101,		//BT		#5
		16'b1110_0000_01010101,		//MOV		#$55,R0
		16'b1110_0001_01010110,		//MOV		#$56,R1
		16'b1110_0010_01111000,		//MOV		#$78,R2
		16'b1000_1011_00000010,		//BF		#2
		16'b1110_0001_00011000,		//MOV		#$18,R1
		16'b1110_0010_00110100,		//MOV		#$34,R2
		...
		16'b0000_0000_0000_1001,	//NOP
		//70
		16'b0100_0000_0000_1010,	//LDS		R0,MACH
		16'b0100_0001_0001_1010,	//LDS		R1,MACL
		16'b0000_0010_0000_1010,	//STS		MACH,R2
		16'b0000_0011_0001_1010,	//STS		MACL,R3
		16'b0100_0001_0000_0010,	//STS		MACH,@-R1
		16'b0100_0001_0001_0010,	//STS		MACL,@-R1
		16'b0000_0000_0010_1000,	//CLRMAC
		16'b0000_0001_0010_0011,	//NOP
		//80
	...
	always @(posedge CLK or negedge RST_N) begin
		...
		if (!RST_N) begin
			...
			case (DSZ)
				2'b00: 
					case (WADDR[1:0])
						2'b00: if (WE[0]) MEM[{WADDR[10:2],1'b0}][15:8] <= DI[7:0];
						2'b01: if (WE[0]) MEM[{WADDR[10:2],1'b0}][ 7:0] <= DI[7:0];
						2'b10: if (WE[0]) MEM[{WADDR[10:2],1'b1}][15:8] <= DI[7:0];
						2'b11: if (WE[0]) MEM[{WADDR[10:2],1'b1}][ 7:0] <= DI[7:0];
					endcase
					
				2'b01: 
					case (WADDR[1])
						1'b0: begin
							if (WE[1]) MEM[{WADDR[10:2],1'b0}][15:8] <= DI[15:8];
							if (WE[0]) MEM[{WADDR[10:2],1'b0}][ 7:0] <= DI[7:0];
						end
						1'b1: begin
							if (WE[1]) MEM[{WADDR[10:2],1'b1}][15:8] <= DI[15:8];
							if (WE[0]) MEM[{WADDR[10:2],1'b1}][ 7:0] <= DI[7:0];
						end
					endcase
					
				default: begin
					if (WE[3]) MEM[{WADDR[10:2],1'b0}][15:8] <= DI[31:24];
					if (WE[2]) MEM[{WADDR[10:2],1'b0}][ 7:0] <= DI[23:16];
					if (WE[1]) MEM[{WADDR[10:2],1'b1}][15:8] <= DI[15:8];
					if (WE[0]) MEM[{WADDR[10:2],1'b1}][ 7:0] <= DI[7:0];
				end
			endcase
	...
	assign DO = DSZ == 2'b00 ? {24'h000000,(!RADDR[0] ? MEM[RADDR[10:1]][15:8] : MEM[RADDR[10:1]][7:0])} :
	            DSZ == 2'b01 ? {16'h0000,MEM[RADDR[10:1]]} :
	            {MEM[{RADDR[10:2],1'b0}],MEM[{RADDR[10:2],1'b1}]};
	
`elsif SIM2

	reg [31:0] MEM [(128*1024*1024)/4];
	initial begin
		$readmemh(bios_file, MEM);
		$readmemh(rom_file, MEM, 'h2000000/4, ('h2400000/4)-1);
	end
